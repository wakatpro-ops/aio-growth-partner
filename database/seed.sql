...
values
  (
    ...
    '{"ai_post_generation":true,"ai_review_reply":true,"aio_diagnosis":true,"instagram_post":true,"repair_services":false,"billing":false,"accounting":false}',
  ...
  (
    ...
    '{"ai_post_generation":true,"ai_review_reply":true,"aio_diagnosis":true,"instagram_post":false,"repair_services":true,"billing":false,"accounting":false}',
...
where module.key in ('store_profile','multi_store','ai_post_generation','ai_review_reply','aio_diagnosis','admin')
...
values
  ...
  ('starter', 'enabled_modules', '["store_profile","multi_store","ai_post_generation","ai_review_reply","aio_diagnosis"]')
