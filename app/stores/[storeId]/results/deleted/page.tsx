...
import { restoreSearchVisibilityKeywordAction } from "../actions";

export default async function DeletedResultsKeywordsPage({ params, searchParams }: { params: Promise<{ storeId: string }>; searchParams: Promise<{ error?: string; restored?: string }> }) {
