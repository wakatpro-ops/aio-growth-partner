...
export function InitialSetupReviewForm({ review }: { review: InitialSetupReview }) {
  ...
  const answered = [structureLabels[structureMode], authorityLabels[systemAuthorities.reservations], registerLabels[registerMode], `${store.name}の店舗情報`, importAnswer, `${selectedMenus.length}件のメニュー`, `${invoice.issuerName}の請求書設定`];
