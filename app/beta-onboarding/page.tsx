...
const dailyFlow = [
  ...
  { title: "会計の受け渡し", body: "freee向けCSVを出力し、会計処理に使える形でデータを整理します。" }
];

const manualSteps = [
  { title: "ログインする", body: "案内されたURLからログインし、ダッシュボードまたは初回導入画面を開きます。" },
  { title: "店舗を作る", body: "店舗管理から利用する店舗を追加し、自社の店舗名と業態を設定します。" },
  ...
  { title: "SNS投稿文をコピーして使う", body: "SNS投稿支援画面で媒体別の文体、ハッシュタグ、CTAを確認し、投稿先へ反映します。" },
  ...
  return (
    <AppShell>
      ...
      <section className="grid cols-3">
        ...
        <article className="card">
          <p className="muted">困ったとき</p>
          <h2>操作方法</h2>
          <p>ログイン、店舗作成、請求、入金、売上分析、集客支援の基本操作を確認できます。</p>
          <Link className="button secondary" href="/help">開く</Link>
        </article>
      </section>
      ...
      <section className="card">
        ...
        <ol className="compact-list">
          ...
          <li>ログイン案内または招待リンクをお送りします。</li>
          <li>ユーザーはログイン後、初回オンボーディングから店舗設定を進めます。</li>
        </ol>
        <p className="notice">導入相談の内容を確認したうえで、担当者より利用開始までの手順をご案内します。</p>
      </section>
      ...
      <section className="card">
        ...
        <ol className="compact-list">
          ...
          <li>Stripe決済URL登録、freee向けCSV出力、Google/Gmail/Calendar接続を確認します。</li>
      ...
      <section className="card">
        <h2>不具合報告テンプレート</h2>
        <p className="muted">困ったときは、以下を分かる範囲で担当者へ送ってください。</p>
        <table className="table">
          <tbody>
