...
for (const route of ["customer-segments", "customer-messages", "bookings", "growth-actions", "growth-calendar", "accounting", "reports"]) assert.match(shell, new RegExp(route, "u"));
