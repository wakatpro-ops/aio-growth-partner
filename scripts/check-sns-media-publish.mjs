...
for (const required of ["8 * 1024 * 1024", "detectImageType", "file_sha256", "duplicate", "requireEditor", "copyright_confirmed", "person_consent_confirmed", "privacy_confirmed", "approval_status", "idempotencyKey", "retry_wait", "manual_required", "media_publish", "/photos"]) assert.ok(service.includes(required), required);
