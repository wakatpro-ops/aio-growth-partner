...
assert.match(setupReview, /AIO boost内の予約管理は現在準備中/u);
assert.match(setupReview, /CSV・Excelで売上を取り込む/u);
assert.doesNotMatch(setupReview, /\["aio_boost", "AIO boostで管理する"\]/u);
