...
try {
  ...
  try {
    ...
    await ownerPage.getByText("メニュー・サービスを2件抽出しました").waitFor();
    ...
    await ownerPage.locator("#menu_unit_price_editor_0").fill("11000");
    ...
    await ownerPage.locator("#invoice_issuer_name_editor").fill("統合テスト株式会社");
    await ownerPage.locator("#invoice_prefix_editor").fill("TEST");
